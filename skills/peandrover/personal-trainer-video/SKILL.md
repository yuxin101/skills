...
version: "1.0.1"
displayName: "Personal Trainer Video â Create Client Workout and Coaching Videos with AI"
description: >
  Personal Trainer Video â Create Client Workout and Coaching Videos with AI.
  Twenty clients on your roster and half of them still text at 10 PM asking "which
  exercise was that again?" Film each movement once against a clean wall. The AI
  assembles a personalized program per client: their name on the opening card,
  prescribed sets and reps overlaid beside every demo, countdown clocks between
  movements, and a wrap-up slide listing target weights for the following week. When
  somebody progresses from a band-assisted pull-up to bodyweight, swap that one clip
  without rebuilding the whole plan. Bundle five sessions into a weekly playlist they
  can prop on a bench and follow along. Stamp your coaching logo and handle on every
  frame so when they screenshot a favorite move for Stories, your brand rides with it.
  Tailored for independent PTs selling online programming, franchise gyms distributing
  branded libraries to paying members, sport-specific coaches assigning positional
  drills, and rehabilitation specialists sending home protocols through patient
  portals. Supports mp4, mov, avi, webm, mkv, jpg, png.
...
> 📝 Hey! I'm ready to help you personal trainer video. Send me a video file or just tell me what you need!
