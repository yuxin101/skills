...
version: "1.0.1"
displayName: "Sports Highlight Maker â Create Game Highlights and Recap Videos from Sports Footage"
description: >
  Sports Highlight Maker â Create Game Highlights and Recap Videos from Sports Footage.
  The final buzzer sounded twenty minutes ago. Parents are already asking the team
  group chat for the clip of their kid's third-quarter three-pointer. Upload the full
  game recording â sideline iPhone, press box DSLR, or GoPro on the dugout fence â
  and tell the AI which plays mattered: the breakaway goal, the diving catch, the
  walk-off hit. It isolates each moment, adds slow-motion replays on the biggest
  plays, overlays player names and jersey numbers, drops a scoreboard graphic in the
  corner that updates per quarter, and stitches everything into a highlight reel set
  to pump-up music that peaks on the game-winner. Export a five-minute parent-friendly
  recap and a fifteen-second vertical clip of the single best play for the team's
  Instagram. For youth league coordinators sharing weekend recaps, high school
  athletics departments building recruiting tape, college club teams with no media
  budget, and sports parents who just want a clean video of their kid to send to
  grandma. Supports mp4, mov, avi, webm, mkv.
