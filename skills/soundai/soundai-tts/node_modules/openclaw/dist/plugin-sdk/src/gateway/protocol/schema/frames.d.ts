...
export declare const ConnectParamsSchema: import("@sinclair/typebox").TObject<{
    ...
    client: import("@sinclair/typebox").TObject<{
        id: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"cli" | "webchat" | "test" | "fingerprint" | "webchat-ui" | "openclaw-control-ui" | "gateway-client" | "openclaw-macos" | "openclaw-ios" | "openclaw-android" | "node-host" | "openclaw-probe">[]>;
