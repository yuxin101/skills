...
import { $n as buildDiscordInteractiveComponents, An as reactMessageDiscord, Cb as recordChannelActivity, Fv as hasControlCommand, Gv as resolveEnvelopeFormatOptions, In as sendDiscordComponentMessage, Mn as removeReactionDiscord, Mv as resolveMentionGatingWithBypass, Nv as createChannelInboundDebouncer, Pv as shouldDebounceTextInbound, Qr as resolveDiscordChannelConfigWithFallback, Qv as dispatchInboundMessage, TC as resolveDiscordMaxLinesPerMessage, Uv as formatInboundEnvelope, Xi as ChannelType, Yr as normalizeDiscordSlug, ai as resolveGroupDmAllow, ci as formatDiscordUserTag, eC as EmbeddedBlockChunker, ea as MessageType, ei as resolveDiscordGuildEntry, ia as Routes, ii as resolveDiscordShouldRequireMention, li as resolveDiscordSystemLocation, ni as resolveDiscordOwnerAccess, nr as sendMessageDiscord, or as sendWebhookMessageDiscord, pn as normalizeDiscordOutboundTarget, qr as isDiscordGroupAllowedByPolicy, rr as sendPollDiscord, ry as createReplyDispatcherWithTyping, ti as resolveDiscordMemberAccessState, ui as resolveTimestampMs, un as fetchPluralKitMessageInfo, ur as editMessageDiscord, xi as chunkDiscordTextWithMode } from "./pi-embedded-BaSvmUpW.js";
...
import { S as resolveTextChunkLimit, T as stripReasoningTagsFromText, u as convertMarkdownTables, x as resolveChunkMode } from "./text-runtime-B-kOpuLv.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-CKwr8YlT.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
