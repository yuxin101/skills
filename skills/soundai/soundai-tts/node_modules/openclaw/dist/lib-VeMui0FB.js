...
import { t as require_content_type } from "./content-type-DVHvQkti.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-CxFmerDs.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-hRlHIlXK.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-Sfzn2WPh.js";
import { l as toRatio, n as decodeString } from "./Util-CRnelCGQ.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CVsjZZ6A.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-BYaJu6wR.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BHcLxz74.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-vwCkxoTm.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Cc6XumUH.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-B3lD-Nbh.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DC0gTib1.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-wBQ6-aXc.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BIlYGQnd.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BdwkwrCp.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-B30cTGqU.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Bbf-jF3c.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DjxzSYE0.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-idCw8Uue.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DCmlG8jN.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-SGK9x4FU.js")).WaveParser;
	}
};
//#endregion
