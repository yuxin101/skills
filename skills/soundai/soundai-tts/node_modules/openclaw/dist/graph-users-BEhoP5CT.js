...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-B5zoW1KK.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BjRl_j1f.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const { createServiceTokenValidator } = await import("./jwt-validator-BKHS8F80.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
