...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-B9wJaN52.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B9wJaN52.js");
	} catch (err) {
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-B9wJaN52.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
