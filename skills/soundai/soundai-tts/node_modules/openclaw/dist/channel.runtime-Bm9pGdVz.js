...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CH5O41A1.js";
import { t as sendMessageZalo } from "./send-CgsDSaFg.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Bx-JmUPb.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-Do6y4-m3.js");
