...
import { h as resolveControlUiLinks, i as ensureWorkspaceAndSessions, l as normalizeGatewayTokenInput, n as applyWizardMetadata, p as randomToken, s as handleReset, t as DEFAULT_WORKSPACE, y as waitForGatewayReachable } from "./onboard-helpers-Dol668Y7.js";
...
import { t as runSetupWizard } from "./setup-BDhXjhpG.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BZ8b2tDZ.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-fOyo6qaV.js");
