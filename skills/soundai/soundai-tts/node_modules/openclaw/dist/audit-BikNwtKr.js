...
import { Q as resolveBrowserControlAuth, q as redactCdpUrl } from "./client-fetch-rOaJaND5.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CQOgm-XY.js";
...
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-Bg3Uo2Lz.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-FXQVz5v6.js"),
		import("./probe-auth-B9DP34c7.js"),
		import("./probe-ivkUzlb_.js")
