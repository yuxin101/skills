import{i as e,n as t}from"./lit-BZwq2xLD.js";import{l as n}from"./format-DeRVtGzv.js";import{A as r,C as i,D as a,F as o,O as s,S as c,T as l,_ as u,a as d,b as f,d as p,f as m,g as h,h as g,k as _,m as v,n as y,p as b,r as x,t as S,u as C,v as w,w as T,x as E,y as D}from"./index-Ij2djnNX.js";import{r as O}from"./channel-config-extras-ClZgd1ad.js";import{i as k,n as A,r as j,t as M}from"./skills-shared-DMlqIU2G.js";function N(n){let{agent:r,configForm:i,agentFilesList:a,configLoading:o,configSaving:s,configDirty:c,onConfigReload:l,onConfigSave:d,onModelChange:p,onModelFallbacksChange:g,onSelectPanel:_}=n,v=w(i,r.id),y=(a&&a.agentId===r.id?a.workspace:null)||v.entry?.workspace||v.defaults?.workspace||`default`,b=v.entry?.model?f(v.entry?.model):f(v.defaults?.model),x=f(v.defaults?.model),S=E(v.entry?.model),C=E(v.defaults?.model)||(x===`-`?null:h(x)),T=S??C??null,O=D(v.entry?.model)??[],k=Array.isArray(v.entry?.skills)?v.entry?.skills:null,A=k?.length??null,j=!!(n.defaultId&&r.id===n.defaultId),M=!i||o||s,N=e=>{let t=O.filter((t,n)=>n!==e);g(r.id,t)};return e`
    <section class="card">
          ...
          <div class="field">
            ...
            <div class="agent-chip-input" @click=${e=>{let t=e.currentTarget.querySelector(`input`);t&&t.focus()}}>
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=u(t.value);n.length>0&&(g(r.id,[...O,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=u(t.value);n.length>0&&(g(r.id,[...O,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
        <div class="agent-model-actions">
          <button type="button" class="btn btn--sm" ?disabled=${o} @click=${l}>
            Reload Config
          </button>
          <button
            type="button"
...
${e}
        ...
        ${i.length===0?e`
              ...
              `:e`
                <div class="list" style="margin-top: 16px;">
                  ${i.map(n=>{let i=le(n.accounts),a=i.total?`${i.connected}/${i.total} connected`:`no accounts`,o=i.configured?`${i.configured} configured`:`not configured`,s=i.total?`${i.enabled} enabled`:`disabled`,c=O({configForm:r.configForm,channelId:n.id,fields:ce});return e`
                      <div class="list-item">
                        <div class="list-main">
  ...
  `}function fe(n){let i=n.agentFilesList?.agentId===n.agentId?n.agentFilesList:null,o=i?.files??[],c=n.agentFileActive??null,l=c?o.find(e=>e.name===c)??null:null,u=c?n.agentFileContents[c]??``:``,d=c?n.agentFileDrafts[c]??u:``,f=c?d!==u:!1;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      ${i?e`<div class="muted mono" style="margin-top: 8px;">Workspace: <span>${i.workspace}</span></div>`:t}
      ...
      ${i?o.length===0?e`
              ...
              `:e`
                <div class="agent-tabs" style="margin-top: 14px;">
                  ${o.map(r=>{let i=c===r.name,a=r.name.replace(/\.md$/i,``);return e`
                      <button
                ...
                ${l?e`
                        ...
                        <label class="field agent-file-field" style="margin-top: 12px;">
                          ...
                          <textarea
                            ...
                            .value=${d}
                            @input=${e=>n.onFileDraftChange(l.name,e.target.value)}
                          ></textarea>
                        </label>
                        <dialog
                          ...
                          <div class="md-preview-dialog__panel">
                            <div class="md-preview-dialog__header">
                              ...
                              <div class="md-preview-dialog__actions">
                                ...
                                ><span class="when-normal">${_.maximize} Expand</span><span class="when-fullscreen">${_.minimize} Collapse</span></button>
                                <button
                                  class="btn btn--sm"
                                  title="Edit file"
                                  @click=${e=>{e.currentTarget.closest(`dialog`)?.close(),document.querySelector(`.agent-file-textarea`)?.focus()}}
                                >${_.edit} Editor</button>
                                <button
                                  class="btn btn--sm"
                            ...
                            <div class="md-preview-dialog__body">
                              ${r(ie(a.parse(d,{gfm:!0,breaks:!0}),{sanitize:e=>s.sanitize(e)}))}
                            </div>
                          </div>
                        </dialog>
                      `:e`
  ...
  `}function me(e){return e.source===`plugin`?e.pluginId?`Connected: ${e.pluginId}`:`Connected`:e.source===`channel`?e.channelId?`Channel: ${e.channelId}`:`Channel`:`Built-in`}function he(n){let r=w(n.configForm,n.agentId),a=r.entry?.tools??{},o=r.globalTools??{},s=a.profile??o.profile??`full`,u=i(n.toolsCatalogResult),d=T(n.toolsCatalogResult),f=a.profile?`agent override`:o.profile?`global default`:`default`,p=Array.isArray(a.allow)&&a.allow.length>0,m=Array.isArray(o.allow)&&o.allow.length>0,h=!!n.configForm&&!n.configLoading&&!n.configSaving&&!p&&!(n.toolsCatalogLoading&&!n.toolsCatalogResult&&!n.toolsCatalogError),g=p?[]:Array.isArray(a.alsoAllow)?a.alsoAllow:[],_=p?[]:Array.isArray(a.deny)?a.deny:[],y=p?{allow:a.allow??[],deny:a.deny??[]}:c(s)??void 0,x=d.flatMap(e=>e.tools.map(e=>e.id)),S=e=>{let t=b(e,y),n=v(e,g),r=v(e,_);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},C=x.filter(e=>S(e).allowed).length,E=(e,t)=>{let r=new Set(g.map(e=>l(e)).filter(e=>e.length>0)),i=new Set(_.map(e=>l(e)).filter(e=>e.length>0)),a=S(e).baseAllowed,o=l(e);t?(i.delete(o),a||r.add(o)):(r.delete(o),i.add(o)),n.onOverridesChange(n.agentId,[...r],[...i])},D=e=>{let t=new Set(g.map(e=>l(e)).filter(e=>e.length>0)),r=new Set(_.map(e=>l(e)).filter(e=>e.length>0));for(let n of x){let i=S(n).baseAllowed,a=l(n);e?(r.delete(a),i||t.add(a)):(t.delete(a),r.add(a))}n.onOverridesChange(n.agentId,[...t],[...r])};return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        ...
        <div class="row" style="gap: 8px; flex-wrap: wrap;">
          <button class="btn btn--sm" ?disabled=${!h} @click=${()=>D(!0)}>
            Enable All
          </button>
          <button class="btn btn--sm" ?disabled=${!h} @click=${()=>D(!1)}>
            Disable All
          </button>
                                ...
                                ${t.tools.map(t=>e`
                                    <div class="agent-tool-row">
                                      <div>
                                        ...
                                        <div style="display: flex; gap: 6px; flex-wrap: wrap; margin-top: 6px;">
                                          <span class="agent-pill">${me(t)}</span>
                                        </div>
                                      </div>
                                    </div>
                                  `)}
    ...
    <div class="agents-layout">
        ...
        <div class="agents-toolbar-row">
          ...
          <div class="agents-toolbar-actions">
            ${o?e`
                    ...
                    >${i&&o.id===i?`Default`:`Set Default`}</button>
                  `:t}
      ...
      <section class="agents-main">
        ${o?e`
                ...
                ${n.activePanel===`channels`?ue({context:p(o,n.config.form,n.agentFiles.list,i,n.agentIdentityById[o.id]??null),configForm:n.config.form,snapshot:n.channels.snapshot,loading:n.channels.loading,error:n.channels.error,lastSuccess:n.channels.lastSuccess,onRefresh:n.onChannelsRefresh,onSelectPanel:n.onSelectPanel}):t}
                ${n.activePanel===`cron`?de({context:p(o,n.config.form,n.agentFiles.list,i,n.agentIdentityById[o.id]??null),agentId:o.id,jobs:n.cron.jobs,status:n.cron.status,loading:n.cron.loading,error:n.cron.error,onRefresh:n.onCronRefresh,onRunNow:n.onCronRunNow,onSelectPanel:n.onSelectPanel}):t}
              `:e`
                <div class="card">
...
//# sourceMappingURL=agents-BxjbKlLv.js.map