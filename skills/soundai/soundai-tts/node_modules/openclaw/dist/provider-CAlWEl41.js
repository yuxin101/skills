...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-XJahKVCp.js";
...
import { $b as canonicalizeAllowlistWithResolvedIds, $i as GatewayOpcodes$1, $l as dispatchReplyWithDispatcher, Ai as MessageReactionAddListener, Bi as UserSelectMenu, Br as stripUndefinedFields, CC as resolveDiscordAccount, Ci as TextDisplay, Cn as registerGateway, Di as GuildDeleteListener, Dt as dispatchPluginInteractiveHandler, Dv as resolveNativeCommandSessionTargets, EC as normalizeDiscordToken, Ei as Modal, Fi as VoiceServerUpdateListener, Fo as buildModelsProviderData, Gi as Command, Gn as createDiscordFormModal, Gv as resolveEnvelopeFormatOptions, Hi as RoleSelectMenu, Ii as VoiceStateUpdateListener, Ji as Plugin, Jn as parseDiscordComponentCustomIdForCarbon, Jr as normalizeDiscordAllowList, Ki as ChannelSelectMenu, Kn as formatDiscordComponentEventText, Li as ListenerEvent, Mi as PresenceUpdateListener, Ni as ReadyListener, Oi as InteractionCreateListener, Pi as ThreadUpdateListener, Pn as editDiscordComponentMessage, Qb as buildAllowlistResolutionSummary, Qi as GatewayIntentBits, Ql as dispatchReplyWithBufferedBlockDispatcher, Qr as resolveDiscordChannelConfigWithFallback, Ri as Client, Si as Separator, TC as resolveDiscordMaxLinesPerMessage, Ti as Row, Tl as getPluginCommandSpecs, Ui as MentionableSelectMenu, Uv as formatInboundEnvelope, Vi as StringSelectMenu, Wi as CommandWithSubcommands, Xi as ChannelType, Xn as parseDiscordModalCustomIdForCarbon, Xr as resolveDiscordAllowListMatch, Yi as serializePayload, Yn as parseDiscordModalCustomId, Yr as normalizeDiscordSlug, Zb as addAllowlistUserEntriesFromConfigEntry, Zi as GatewayCloseCodes$1, Zl as createReplyReferencePlanner, _b as resolveExecApprovalCommandDisplay, _l as executePluginCommand, ab as wrapFetchWithAbortSignal, ai as resolveGroupDmAllow, ci as formatDiscordUserTag, ei as resolveDiscordGuildEntry, er as resolveDiscordComponentEntry, hb as getExecApprovalApproverDmNoticeText, ia as Routes, ji as MessageReactionRemoveListener, ki as MessageCreateListener, la as setPresence, na as ButtonStyle, ni as resolveDiscordOwnerAccess, nx as summarizeMapping, oi as shouldEmitDiscordReactionNotification, qi as Button, qn as parseDiscordComponentCustomId, qr as isDiscordGroupAllowedByPolicy, ra as ChannelType$1, si as formatDiscordReactionEmoji, sr as formatMention, ta as ApplicationCommandOptionType, ti as resolveDiscordMemberAccessState, tr as resolveDiscordModalEntry, tx as patchAllowlistUsersInConfigEntries, vi as createDiscordClient, wi as Container, wn as unregisterGateway, xi as chunkDiscordTextWithMode, yl as matchPluginCommand, zi as RateLimitError } from "./pi-embedded-BaSvmUpW.js";
import { i as resolveAgentRoute } from "./resolve-route-C5Xj9lGN.js";
import { S as resolveTextChunkLimit, r as chunkItems, t as withTimeout, w as summarizeStringEntries, x as resolveChunkMode } from "./text-runtime-B-kOpuLv.js";
...
import { o as resolveStoredModelOverride } from "./level-overrides-CuN7Qk6r.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-BeNpL0xB.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-amxUt67a.js");
