import { an as normalizePluginsConfig, bi as resolveDefaultAgentId, en as MANIFEST_KEY } from "./env-D1ktUnAV.js";
import { h as resolveOAuthDir } from "./paths-CjuwkA2v.js";
...
import { i as safeStat, n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-7IxnGQxG.js";
import { t as formatCliCommand } from "./command-format-CCyUqeuM.js";
import { a as resolveNativeSkillsEnabled } from "./commands-AceByDw5.js";
import { B as resolveToolProfilePolicy, E as resolveSandboxConfigForAgent, G as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, a as execDockerRaw, j as resolveEffectiveSandboxToolPolicyForAgent } from "./docker-BrzH-NvE.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-BooYyzLb.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-D45eoPB6.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-BFKe2WSK.js");
...
function resolveToolPolicies(params) {
	...
	if (params.sandboxMode === "all") policies.push(resolveEffectiveSandboxToolPolicyForAgent(params.cfg, params.agentId ?? void 0));
	return policies;
}
