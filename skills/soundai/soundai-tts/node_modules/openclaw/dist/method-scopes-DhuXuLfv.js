import { Xi as logError, Yi as logDebug } from "./env-D1ktUnAV.js";
import { _ as resolveStateDir } from "./paths-CjuwkA2v.js";
import { n as VERSION } from "./version-DGzLsBG-.js";
import { n as FILE_SECRET_REF_ID_PATTERN, p as ENV_SECRET_REF_ID_RE, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-BFBhfQKU.js";
import { a as isSecureWebSocketUrl, r as isLoopbackHost } from "./net-1LAzWzJc.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES, p as GATEWAY_CLIENT_IDS } from "./message-channel-ZzTqBBLH.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-CBJJKMt_.js";
import { t as rawDataToString } from "./ws-CPolAahN.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-B9YUYCGo.js";
...
//#endregion
export { validateExecApprovalsNodeSetParams as $, ErrorCodes as $t, validateConfigPatchParams as A, validateSessionsPatchParams as At, validateCronRunsParams as B, validateTalkConfigParams as Bt, validateChannelsStatusParams as C, validateSessionsAbortParams as Ct, validateChatSendParams as D, validateSessionsListParams as Dt, validateChatInjectParams as E, validateSessionsDeleteParams as Et, validateConnectParams as F, validateSessionsUsageParams as Ft, validateDevicePairRejectParams as G, validateUpdateRunParams as Gt, validateCronUpdateParams as H, validateTalkSpeakParams as Ht, validateCronAddParams as I, validateSkillsBinsParams as It, validateDeviceTokenRotateParams as J, validateWebLoginWaitParams as Jt, validateDevicePairRemoveParams as K, validateWakeParams as Kt, validateCronListParams as L, validateSkillsInstallParams as Lt, validateConfigSchemaLookupResult as M, validateSessionsResetParams as Mt, validateConfigSchemaParams as N, validateSessionsResolveParams as Nt, validateConfigApplyParams as O, validateSessionsMessagesSubscribeParams as Ot, validateConfigSetParams as P, validateSessionsSendParams as Pt, validateExecApprovalsNodeGetParams as Q, validateWizardStatusParams as Qt, validateCronRemoveParams as R, validateSkillsStatusParams as Rt, validateChannelsLogoutParams as S, validateSendParams as St, validateChatHistoryParams as T, validateSessionsCreateParams as Tt, validateDevicePairApproveParams as U, validateToolsCatalogParams as Ut, validateCronStatusParams as V, validateTalkModeParams as Vt, validateDevicePairListParams as W, validateToolsEffectiveParams as Wt, validateExecApprovalResolveParams as X, validateWizardNextParams as Xt, validateExecApprovalRequestParams as Y, validateWizardCancelParams as Yt, validateExecApprovalsGetParams as Z, validateWizardStartParams as Zt, validateAgentsFilesGetParams as _, verifyDeviceSignature as _n, validatePollParams as _t, READ_SCOPE as a, ConnectErrorDetailCodes as an, validateNodeInvokeParams as at, validateAgentsListParams as b, validateSecretsResolveParams as bt, isNodeRoleMethod as c, getPreauthHandshakeTimeoutMsFromEnv as cn, validateNodePairApproveParams as ct, formatValidationErrors as d, normalizeFingerprint as dn, validateNodePairRequestParams as dt, errorShape as en, validateExecApprovalsSetParams as et, validateAgentIdentityParams as f, deriveDeviceIdFromPublicKey as fn, validateNodePairVerifyParams as ft, validateAgentsDeleteParams as g, signDevicePayload as gn, validateNodeRenameParams as gt, validateAgentsCreateParams as h, publicKeyRawBase64UrlFromPem as hn, validateNodePendingEnqueueParams as ht, PAIRING_SCOPE as i, normalizeInputProvenance as in, validateNodeEventParams as it, validateConfigSchemaLookupParams as j, validateSessionsPreviewParams as jt, validateConfigGetParams as k, validateSessionsMessagesUnsubscribeParams as kt, resolveLeastPrivilegeOperatorScopesForMethod as l, buildDeviceAuthPayload as ln, validateNodePairListParams as lt, validateAgentWaitParams as m, normalizeDevicePublicKeyBase64Url as mn, validateNodePendingDrainParams as mt, APPROVALS_SCOPE as n, applyInputProvenanceToUserMessage as nn, validateModelsListParams as nt, WRITE_SCOPE as o, resolveAuthConnectErrorDetailCode as on, validateNodeInvokeResultParams as ot, validateAgentParams as p, loadOrCreateDeviceIdentity as pn, validateNodePendingAckParams as pt, validateDeviceTokenRevokeParams as q, validateWebLoginStartParams as qt, CLI_DEFAULT_OPERATOR_SCOPES as r, hasInterSessionUserProvenance as rn, validateNodeDescribeParams as rt, authorizeOperatorScopesForMethod as s, resolveDeviceAuthConnectErrorDetailCode as sn, validateNodeListParams as st, ADMIN_SCOPE as t, parseSessionLabel as tn, validateLogsTailParams as tt, GatewayClient as u, buildDeviceAuthPayloadV3 as un, validateNodePairRejectParams as ut, validateAgentsFilesListParams as v, validatePushTestParams as vt, validateChatAbortParams as w, validateSessionsCompactParams as wt, validateAgentsUpdateParams as x, validateSecretsResolveResult as xt, validateAgentsFilesSetParams as y, validateRequestFrame as yt, validateCronRunParams as z, validateSkillsUpdateParams as zt };
