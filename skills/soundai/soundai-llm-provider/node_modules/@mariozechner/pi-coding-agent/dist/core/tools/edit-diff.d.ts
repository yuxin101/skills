 ...
 */
export declare function applyEditsToNormalizedContent(normalizedContent: string, edits: ReplaceEdit[], path: string): AppliedEditsResult;
/**
 ...
 */
export declare function computeEditsDiff(path: string, edits: ReplaceEdit[], cwd: string): Promise<EditDiffResult | EditDiffError>;
/**
