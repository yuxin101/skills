...
import { aL as logConfigUpdated, g as readConfigFileSnapshot, x as writeConfigFile } from "./auth-profiles-B5ypC5S-.js";
...
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-ZUKC4WUi.js";
import { t as createClackPrompter } from "./clack-prompter-CrErWfG1.js";
import { t as runSetupWizard } from "./setup-G-dNF0eQ.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-CHjie4bD.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BxgA06M4.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-DuuMc0dF.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CNxAIU-n.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CHfM13PQ.js");
