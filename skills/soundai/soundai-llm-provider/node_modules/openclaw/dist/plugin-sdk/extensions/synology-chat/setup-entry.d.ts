declare const _default: {
    plugin: Omit<import("openclaw/plugin-sdk/core").ChannelPlugin<import("./src/types.ts").ResolvedSynologyChatAccount>, "pairing" | "gateway" | "security" | "messaging" | "directory" | "outbound" | "agentPrompt"> & {
        pairing: {
            idLabel: string;
