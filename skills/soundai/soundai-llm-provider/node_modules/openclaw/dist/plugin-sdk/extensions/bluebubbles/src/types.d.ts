...
export declare function _setFetchGuardForTesting(impl: typeof fetchWithSsrFGuard | null): void;
export declare function blueBubblesFetchWithTimeout(url: string, init: RequestInit, timeoutMs?: number, ssrfPolicy?: SsrFPolicy): Promise<Response>;
