...
type SendChatActionFn = (chatId: number | string, action: ChatAction, threadParams?: TelegramSendChatActionParams) => Promise<true>;
export type TelegramSendChatActionHandler = {
     ...
     */
    sendChatAction: (chatId: number | string, action: ChatAction, threadParams?: TelegramSendChatActionParams) => Promise<void>;
    isSuspended: () => boolean;
    reset: () => void;
};
