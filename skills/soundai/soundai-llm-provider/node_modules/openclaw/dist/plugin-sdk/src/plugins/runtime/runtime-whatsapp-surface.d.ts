...
export type WhatsAppHeavyRuntimeModule = {
    loginWeb: (verbose: boolean, waitForConnection?: (sock: WhatsAppWaSocket) => Promise<void>, runtime?: RuntimeEnv, accountId?: string) => Promise<void>;
    ...
    monitorWebChannel: (verbose: boolean, listenerFactory?: MonitorWebInboxFactory, keepAlive?: boolean, replyResolver?: ReplyResolver, runtime?: RuntimeEnv, abortSignal?: AbortSignal, tuning?: WebMonitorTuning) => Promise<void>;
    ...
    extractMediaPlaceholder: (message: unknown, mediaDir: string, verbose?: boolean) => Promise<string | null>;
