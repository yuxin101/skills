...
import { ak as trimToUndefined, ek as isGatewaySecretRefUnavailableError, l as createConfigIO, ok as loadGatewayTlsRuntime } from "./auth-profiles-B5ypC5S-.js";
...
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-ZUKC4WUi.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-BXdDL3Xq.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-fKq3W9Y5.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-D0KZcMpX.js");
