import { Qk as normalizeTrustedSafeBinDirs, Uk as resolveMergedSafeBinProfileFixtures, Vk as listInterpreterLikeSafeBins, Wv as redactCdpUrl, cA as listRiskyConfiguredSafeBins, cy as resolveProfile, hk as isInterpreterLikeAllowlistPattern, my as resolveBrowserControlAuth, ob as resolveGatewayAuth, sy as resolveBrowserConfig, xk as loadExecApprovals } from "./auth-profiles-B5ypC5S-.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-q0KQqgWC.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-ATXfrtIQ.js";
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-Dzunjp-J.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-B8ms-sSq.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BaQyTXTT.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-fKq3W9Y5.js"),
		import("./probe-auth-BWOBKNV3.js"),
		import("./probe-D0KZcMpX.js")
