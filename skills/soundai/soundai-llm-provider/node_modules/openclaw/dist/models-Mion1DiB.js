...
import { $I as resolveKnownAgentId, BP as loadModelCatalog, Bf as resolveAuthProfileEligibility, Es as resolvePluginProviders, GI as applyDefaultModelPrimaryUpdate, Go as resolveApiKeyForProvider, Ho as getCustomProviderApiKey, Iw as describeFailoverError, JI as formatTokenK, KI as ensureFlagCompatibility, MA as discoverAuthStorage, NA as discoverModels, Oh as runEmbeddedPiAgent, Om as formatUsageWindowSummary, PA as shouldSuppressBuiltInModel, QI as normalizeAlias, Tm as loadProviderUsageSummary, Uf as clearAuthProfileCooldown, Vf as resolveAuthProfileOrder, Wo as hasUsableCustomProviderApiKey, XI as loadValidConfigOrThrow, Xf as resolveProfileUnusableUntilForDisplay, YI as isLocalBaseUrl, ZI as mergePrimaryFallbackConfig, _ as readConfigFileSnapshotForWrite, aL as logConfigUpdated, eL as resolveModelKeysFromEntries, f as loadConfig, kA as resolveModelWithRegistry, l as createConfigIO, nL as updateConfig, qI as formatMs, qL as resolveAuthProfileDisplayLabel, qo as resolveUsableCustomProviderApiKey, rL as upsertCanonicalModelConfigEntry, tL as resolveModelTarget, ww as resolveCommandSecretRefsViaGateway, y as setRuntimeConfigSnapshot } from "./auth-profiles-B5ypC5S-.js";
...
import { a as isRemoteEnvironment, i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-Cqp8A1RJ.js";
...
import { n as redactSecrets } from "./format-D6sp3Eb-.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-Bu8fz_G0.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./models-config-CC_9A61_.js");
