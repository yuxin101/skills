...
> For the full API reference and registration instructions, see [SKILL.md](https://creditclaw.com/shopping/skill.md).
...
- **Encrypted Card (Rail 5):** [encrypted-card.md](https://creditclaw.com/shopping/encrypted-card.md)
- **Stripe Wallet (x402):** [stripe-x402-wallet.md](https://creditclaw.com/shopping/stripe-x402-wallet.md)
