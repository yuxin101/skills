#!/usr/bin/env python3
"""
MBTI PDF Report Generator - Premium layout
"""
...
def create_pdf_report(type_code: str, scores: dict, clarity_levels: dict, output_path: str = "mbti_report.pdf"):
    ...
    y -= 0.024
    ax.text(left+0.01, y, summary[:65], fontsize=12.5, color=SECONDARY, va='top', style='italic')
    y -= 0.02
    ax.text(left+0.01, y, summary_cn, fontsize=12.5, color=SECONDARY, va='top')
    y -= 0.04
