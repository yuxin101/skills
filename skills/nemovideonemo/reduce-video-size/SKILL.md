...
version: "1.0.0"
displayName: "Video Compressor - Compress and Reduce Video File Size with AI"
description: >
  Video compressor that reduces video file size through AI chat. Upload a video and
  specify your target: "compress to under 25MB for email" or "reduce file size by 50%
  while keeping quality" or "make this small enough for WhatsApp." The AI analyzes your
  footage and applies optimal compression settings — adjusting bitrate, resolution, and
  encoding parameters to hit your target size with minimal quality loss. Handles batch
  compression of multiple files, format conversion during compression, and resolution
  downscaling for specific platforms. Compress 4K footage for social media upload,
  shrink screen recordings for sharing, reduce raw camera files for storage, and prepare
  videos for email attachments. Describe your size or quality target in words and get
  compressed MP4 back. No encoding software needed. Supports mp4, mov, avi, webm, mkv.
...
**Target size**: "Under 25MB" or "under 10MB" gives the AI a clear goal.

**Quality vs size**: "Keep quality high, just reduce a bit" vs "smallest possible, quality doesn't matter."

**Platform targets**: "Compress for WhatsApp" or "optimize for email" auto-applies known limits.
