---
name: twitter-video-maker
version: "1.0.1"
displayName: "Twitter Video Maker â Create Engaging X and Twitter Video Posts with AI"
description: >
  Twitter Video Maker â Create Engaging X and Twitter Video Posts with AI.
  Text tweets plateau at a few hundred impressions. Video posts on X get ten times
  the algorithmic push â but nobody opens Premiere for a thirty-second opinion. Paste
  your thread or talking points, choose a format â animated text on a branded
  background, a talking-head recording with burned-in captions, or a screen walkthrough
  with highlight callouts â and the AI delivers a file sized for the feed within
  seconds. Auto-fits the 2:20 duration ceiling. Bold subtitles bake in because most
  of the timeline scrolls on mute. Your handle stays pinned so quote-tweets still
  credit the source. Line up an entire week of posts in one conversation. Built for
  brand accounts posting daily, indie founders documenting the build, newsletter
  writers repurposing editions into clips, and commentators who learned that nothing
  goes viral on X faster than a face plus a hot take. Supports mp4, mov, webm, png.
...
> 🎙️ Hey! I'm ready to help you twitter video maker. Send me a video file or just tell me what you need!
