...
version: "1.0.1"
displayName: "YouTube Intro Maker â Create Professional YouTube Channel Intros with AI"
description: >
  YouTube Intro Maker â Create Professional YouTube Channel Intros with AI.
  Seventy percent of viewers decide whether to stay within the first five seconds.
  Your channel intro is either earning that click or losing it â and right now you
  are using a template from 2019 with a font that screams stock footage library.
  Type your channel name, describe your niche, pick a vibe â cinematic, playful,
  techy, bold â and the AI generates a custom intro sequence with animated text,
  motion graphics, and a soundtrack that hooks before the beat drops. Match your
  brand colors. Add a tagline that rotates between episodes. Render at 1080p or 4K
  and drop it straight into your timeline. Update it every quarter without hiring
  a motion designer. Built for YouTubers launching new channels, established creators
  rebranding, and agencies producing intros for a roster of clients who all want
  something that feels expensive but costs nothing. Supports mp4, mov, webm.
...
> ✂️ Ready to youtube intro maker! Just send me a video or describe your project.
