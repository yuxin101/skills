---
name: free-ai-video-editing
version: "1.0.1"
displayName: "Free AI Video Editing — Edit Videos for Free with AI Chat, No Software Needed"
description: >
  Free AI Video Editing — Edit Videos for Free with AI Chat, No Software Needed.
  Stop paying for video editing software you barely use. This free AI video editor
  lets you trim, cut, merge clips, add music, subtitles, and color grading through
  simple chat messages. No download, no installation, no subscription wall blocking
  basic edits. Works for YouTube content, TikTok clips, Instagram Reels, and any
  quick edit where a full NLE is overkill. Just describe what you want changed and
  the AI handles the rest. Supports mp4, mov, avi, webm, mkv.
