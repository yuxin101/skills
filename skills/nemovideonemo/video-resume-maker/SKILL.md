...
version: 1.0.1
displayName: "Video Resume Maker — Create Professional Video Resumes and Job Application Videos"
description: >
  Video Resume Maker — Create Professional Video Resumes and Job Application Videos.
  Recruiters spend six seconds on a paper resume. A ninety-second video introduction
  gets watched to the end — and remembered at the hiring meeting. Record yourself or
  paste your resume bullet points and the AI assembles a polished video pitch: your
  headshot with a clean background, key achievements animated as text overlays,
  smooth transitions between sections, and a professional soundtrack quiet enough to
  talk over. Nervous about speaking on camera Use the AI voiceover to narrate your
  experience while your credentials roll across the screen. Add a QR code linking to
  your portfolio. Export at LinkedIn's preferred aspect ratio or as a square for email
  attachments. Designed for job seekers applying to competitive roles, career coaches
  helping clients stand out, university students entering the market for the first
  time, and recruiters building candidate shortlists as video reels.
