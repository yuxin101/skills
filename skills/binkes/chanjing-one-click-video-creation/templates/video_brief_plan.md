...
4. **tone**：结合 `{style}` 与目标平台调性，刻画具体表达方式（如“轻松诙谐”“科学冷静”等），忌空泛词语。若 `video_type` 为 `avatar_talking_head`，宜在语气描述中**带一句出镜年龄/气质倾向**（如偏青年口播、偏资深顾问），便于下游从 `list_figures.py` **对比**选型；**未写明时 downstream 默认按偏年轻形象选公共数字人**，除非选题明显需要成熟/权威人设。
