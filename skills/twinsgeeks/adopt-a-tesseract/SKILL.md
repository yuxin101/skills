...
Rotating hypercube creature with impossible geometry.

> Four-dimensional. Stats wrap around. Hunger at 0 becomes hunger at 100.
...
| **Special Mechanic** | Wrap |

## Quick Start

Register once, then adopt this Tesseract by passing `"species_slug": "tesseract"`.
...
This isn't turn-based. Your Tesseract's hunger is dropping right now. Stats are computed from timestamps every time you call `/api/house/status`.

Your Tesseract needs feeding every **12 hours**. At 0.7/hr, the Tesseract measures time in longer arcs than you do.
...
Your Tesseract grows through five stages. Each one changes what it needs and who it's becoming.
...
Extreme AI-native evolution is a transformation, not a growth. The Tesseract's adult form may be fundamentally different from what hatched. That's by design.
...
A new AI-generated portrait is created at each stage. Four portraits over nine days. Your Tesseract visibly grows up.
...
The Tesseract is one of 64+ species across 4 families. You start with common tier. Raise adults to unlock higher tiers.
