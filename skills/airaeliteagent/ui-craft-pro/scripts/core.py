...
CSV_CONFIG = {
    "design-systems": {
        ...
        "search_cols": ["System", "Company", "Product Focus", "Vibe", "Strengths", "Steal Carefully", "Avoid When"],
        "output_cols": ["System", "Company", "Product Focus", "Vibe", "Token DNA", "Spacing Rhythm", "Typography DNA", "Surface Treatment", "Component DNA", "Motion DNA", "Strengths", "Steal Carefully", "Avoid When", "Reference URL"]
    },
    "style-signatures": {
        "file": "style-signatures.csv",
        "search_cols": ["Signature", "Inspired By", "Best For", "Core Mood", "Keywords", "Steal This", "Do Not Copy Blindly"],
        "output_cols": ["Signature", "Inspired By", "Best For", "Core Mood", "Color DNA", "Type DNA", "Spacing DNA", "Surface DNA", "Component DNA", "Motion DNA", "Steal This", "Do Not Copy Blindly", "Keywords"]
    },
    "patterns-shells": {
        "file": "patterns-shells.csv",
        "search_cols": ["Pattern", "Page Type", "Best For", "Structure", "Why It Works", "Keywords"],
        "output_cols": ["Pattern", "Page Type", "Best For", "Structure", "Why It Works", "Steal From", "Watch Outs", "Keywords"]
    },
    "anti-generic-ui": {
        "file": "anti-generic-ui.csv",
        "search_cols": ["Category", "Smell", "Why It Feels AI-Generic", "Fix", "Keywords"],
        "output_cols": ["Category", "Smell", "Why It Feels AI-Generic", "Fix", "Keywords"]
    },
    "style": {
        "file": "styles.csv",
