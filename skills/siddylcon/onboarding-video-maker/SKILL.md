---
name: onboarding-video-maker
version: "1.0.1"
displayName: "Onboarding Video Maker â Create Employee and Customer Onboarding Videos with AI"
description: >
  Onboarding Video Maker â Create Employee and Customer Onboarding Videos with AI.
  New hires sit through the same thirty-minute orientation talk every Monday morning.
  The presenter is exhausted from repeating it and the newcomers check out by slide
  nineteen. Record the talk once, hand the file to the AI, and let it construct a
  modular welcome series: a CEO intro with branded motion graphics, a benefits
  overview with bullet points synchronized to the narration, an IT setup guide with
  annotated screenshots, and a culture segment spliced from team event footage. Each
  piece stands alone so HR can assign specific chapters by role or department. Revise
  one segment when the health plan changes without re-rendering the rest of the
  library. Append a quiz prompt card at the close of each chapter for LMS completion
  tracking. Deliver files to BambooHR, Rippling, or as plain mp4 in a shared Drive
  folder. Designed for People Ops teams scaling headcount from ten to ten thousand,
  SaaS companies assembling self-serve product walkthroughs, and franchise operators
  standardizing procedures across every new location.
...
> 🎙️ Hey! I'm ready to help you onboarding video maker. Send me a video file or just tell me what you need!
