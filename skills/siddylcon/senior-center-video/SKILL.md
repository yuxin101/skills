---
name: senior-center-video
version: "1.0.0"
displayName: "Senior Center Video Maker — Create Activity Highlight and Family Update Videos"
description: >
  Senior Center Video Maker — Create Activity Highlight and Family Update Videos.
  Tuesday's watercolor class produced twelve paintings, three friendships, and one
  moment where 94-year-old Harold mixed every color into what he called "the most
  expensive mud in the county" — and the room laughed so hard the activities director
  forgot she was recording. The phone captured forty minutes of painting, chatting,
  and Harold's commentary, plus a fifteen-minute segment of the chair-yoga session
  that followed where someone's hearing aid started feeding back during tree pose.
  Upload the full activity footage. The AI identifies the social highlights —
  laughter peaks, conversation exchanges, finished-artwork reveals — and assembles
  a family-update reel: opening welcome card with the center's name and week —
  "Sunrise Senior Living | Week of March 24, 2026 | Activities Recap" — watercolor
  segment with each resident's painting shown alongside their portrait and name —
  "Harold M., age 94 | 'Abstract Landscape' (his words: 'expensive mud')" — chair-
  yoga highlight with gentle pacing and instructor cues visible, lunch-hour candid
  of the Tuesday regulars at their usual table, and a closing calendar card —
  "Coming Next Week: Gardening Club (Tues) | Movie Matinee: Casablanca (Thurs) |
  Family Visiting Day (Sat)." Grade warm and gentle — soft focus on backgrounds,
  golden midday light, nothing clinical or institutional. Layer the ambient room
  sounds: paintbrushes in water, quiet conversation, the squeak of chair legs on
  linoleum. Render a three-minute family-update email attachment, a thirty-second
  Reel of Harold's "expensive mud" moment, and a sixty-second facility-tour teaser
  for the marketing page. Built for assisted-living activity directors keeping
  families connected, memory-care units documenting resident engagement for care
  plans, municipal senior centers producing grant-compliance evidence, and elder-law
  attorneys compiling quality-of-life documentation.
  Supports mp4, mov, webm, jpg, png.
metadata: {"openclaw": {"emoji": "🌅", "requires": {"env": [], "configPaths": ["~/.config/nemovideo/"]}, "primaryEnv": "NEMO_TOKEN"}}
---

# Senior Center Video Maker — Describe the Activity, Connect the Family

No facility staff photographer. No family-visit coordination for footage. No state-report slideshow marathon. Just film the day's activities and describe who's in them. "Show Harold's painting, capture the yoga class, pin the weekly calendar, keep it warm" — your senior update, family-approved.
