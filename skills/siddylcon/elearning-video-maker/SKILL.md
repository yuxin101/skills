---
name: elearning-video-maker
version: "1.0.1"
displayName: "E-Learning Video Maker â Build SCORM and LMS Training Videos with AI"
description: >
  E-Learning Video Maker â Build SCORM and LMS Training Videos with AI.
  Corporate L&D teams produce an average of forty-seven training videos per year and
  most of them die in a shared drive because nobody had time to edit them properly.
  Import your subject-matter-expert recordings, compliance walkthroughs, and screen
  captures. The AI trims hesitations, inserts knowledge-check pause points where you
  mark them, overlays key terminology as on-screen callouts, and packages everything
  into SCORM 1.2 or xAPI modules ready for Moodle, Canvas, Cornerstone, or
  Absorb LMS. Maintain a consistent visual identity across departments â same fonts,
  same lower-thirds, same transition style â without a design team. Localize a module
  into Spanish or Mandarin by swapping the subtitle track and AI voiceover in one
  pass. Track which version is deployed where using the built-in naming convention.
  Designed for L&D managers standardizing onboarding across regions, compliance
  officers updating annual certification content, and instructional designers who
  juggle twelve stakeholders and one overworked video contractor.
...
> ✨ Let's elearning video maker! Drop a video here or describe what you'd like to create.
