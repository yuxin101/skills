---
name: sales-video-maker
version: 1.0.2
displayName: "Sales Video Maker — Create Personalized Sales and Outreach Videos with AI"
description: >
  Sales Video Maker — Create Personalized Sales and Outreach Videos with AI.
  Reps who embed video in outreach emails see three times the reply rate — but
  recording a unique Loom for every prospect on a list of two hundred is a full-time
  job nobody signed up for. Record one master walkthrough of your product. The AI
  generates personalized variants: each prospect's company name spoken by an AI voice
  in the greeting, their logo on the opening slide, a pain-point highlight pulled
  from your CRM notes, and a calendar booking link stamped on the closing frame. Batch
  fifty personalized videos overnight and drip them through your Outreach or Salesloft
  sequence. Track which version gets watched past the thirty-second mark. Refresh the
  demo footage when the product ships a new feature without re-personalizing every
  recipient. Designed for SDR teams scaling pipeline, account executives sending
  renewal proposals, solutions engineers recording technical deep-dives, and revenue
  leaders who want video selling without hiring a videographer.
