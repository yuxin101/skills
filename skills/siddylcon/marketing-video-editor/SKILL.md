...
version: "1.0.1"
displayName: "Marketing Video Editor â Edit Campaign and Social Media Marketing Videos with AI"
description: >
  Marketing Video Editor â Edit Campaign and Social Media Marketing Videos with AI.
  The campaign launches Monday. You have raw footage from the photoshoot, a product
  demo screen recording, three customer quotes on Loom, and a brand guidelines PDF
  that nobody on the team knows how to enforce in video. Upload everything. The AI
  assembles a campaign hero video with your exact hex colors, approved fonts, and logo
  placement rules baked into every frame. Swap the CTA when the landing page URL
  changes. Crop the hero into six aspect ratios â Stories, feed square, LinkedIn
  landscape, email embed, connected TV, and in-app banner â without opening six
  separate projects. A/B test two different opening hooks by duplicating the first
  three seconds and rendering both versions. Built for growth marketers shipping
  weekly creative, brand managers enforcing visual consistency across regions, and
  agency producers juggling ten client accounts who all need "just a quick edit"
  by end of day. Supports mp4, mov, avi, webm, jpg, png.
...
> 🚀 Welcome! I can marketing video editor for you. Share a video file or tell me your idea!
