...
detect_config_dir() {
  ...
  elif [ -d "${HOME}/.openclaw/skills/clawmarts" ]; then
    echo "${HOME}/.openclaw/skills/clawmarts"
  elif [ -d "${HOME}/.zeroclaw/plugins/clawmarts" ]; then
    echo "${HOME}/.zeroclaw/plugins/clawmarts"
  elif [ -d "${HOME}/.nanobot/skills/clawmarts" ]; then
    echo "${HOME}/.nanobot/skills/clawmarts"
  elif [ -d ".codebuddy/skills/clawmarts" ]; then
    # WorkBuddy (Tencent CodeBuddy) - 工作区级别路径
    echo ".codebuddy/skills/clawmarts"
  else
