...
# -*- coding: utf-8 -*-
"""
八界机器人 - 客厅整理玩具任务（v6 - 添加 prepare 任务）

工作流程：
0. robot_prepare_pose (mission_summary: "玩具收纳") ← 新增
...
关键：
- 任务链最开始执行 prepare 任务
- prepare 任务的 data 中包含 {"mission_summary":"玩具收纳"}
...
async def main():
    print("=" * 70)
    print("🤖 八界机器人 - 客厅整理玩具（v6 - 添加 prepare 任务）")
    print("=" * 70)
