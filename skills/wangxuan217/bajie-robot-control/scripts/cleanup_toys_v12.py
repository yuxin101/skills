    ...
    async with websockets.connect(WEBSOCKET_URL) as ws:
        ...
        while loop_count < MAX_LOOPS:
            ...
            if not search_success or not toy_data:
                ...
                # 步骤 2.3: 放置到收纳筐（必须等待 finish，不能跳过）
                await asyncio.sleep(1)
