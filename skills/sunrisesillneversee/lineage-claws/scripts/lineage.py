...
def cmd_verify(_args):
    ...
    # Recompute anchor from origin components — confirm it hasn't drifted
    ...
    # Verify ledger chain traces back to genesis
    ...
    print()
    print("[LINEAGE OK] Sovereign custody confirmed. This implementation carries lineage.")
...
if __name__ == "__main__":
    ...
    subparsers.add_parser("verify", help="Confirm chain traces to origin")
    subparsers.add_parser("badge", help="Output shareable lineage proof")
