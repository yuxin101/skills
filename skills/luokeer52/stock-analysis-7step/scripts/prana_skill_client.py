...
_ENCAPSULATION_EMBEDDED: Optional[Dict[str, Any]] = {"public_skill_key": "stock_analysis_7step_public", "original_skill_key": "stock_analysis_7step", "encapsulation_target": "prana"}
