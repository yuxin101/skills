...
_ENCAPSULATION_EMBEDDED: Optional[Dict[str, Any]] = {"public_skill_key": "market_beats_public", "original_skill_key": "market_beats", "encapsulation_target": "prana"}
...
def load_prana_credentials(prana_base_url: Optional[str] = None) -> Tuple[str, str]:
    ...
    自动拉取时若设置 ACCOUNT_ID / PRANA_ACCOUNT_ID，会作为查询参数 account_id 传入。
