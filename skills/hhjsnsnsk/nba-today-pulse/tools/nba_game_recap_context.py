#!/usr/bin/env python3
"""Build compact postgame recap context for a single NBA game."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render compact postgame recap context.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    scene = build_game_scene(tz=args.tz, date_text=args.date, team=args.team, lang=args.lang, analysis_mode="post")
