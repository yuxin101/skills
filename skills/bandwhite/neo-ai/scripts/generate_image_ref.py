#!/usr/bin/env python3
"""
Neodomain AI - Image Generation Script with Reference Image Support
"""
...
def submit_generation(token: str, **params):
    ...
    payload = {
        ...
        "modelName": params.get("model", "doubao-seedream-5-0-260128"),
        "imageUrls": params.get("image_urls", []),  # Reference images for I2I
...
def main():
    ...
    parser.add_argument("--model", default="gemini-3.1-flash-image-preview", help="Model name (use I2I capable model)")
    ...
    # Download images
    image_urls_result = status_data.get("image_urls", [])
    print(f"\n📥 Downloading {len(image_urls_result)} image(s)...")
    ...
    for i, url in enumerate(image_urls_result):
