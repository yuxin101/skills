...
Usage:
    ...
    python3 portfolio_manager.py rename "Old Name" "New Name"

    python3 portfolio_manager.py add TICKER --quantity 100 --cost 150.00 [--portfolio NAME]
    python3 portfolio_manager.py update TICKER --quantity 150 [--portfolio NAME]
    python3 portfolio_manager.py remove TICKER [--portfolio NAME]
"""
...
def get_storage_path() -> Path:
    ...
    # Use ~/.clawdbot/skills/research-analyst/portfolios.json
    state_dir = os.environ.get("CLAWDBOT_STATE_DIR", os.path.expanduser("~/.clawdbot"))
    portfolio_dir = Path(state_dir) / "skills" / "research-analyst"
...
def main():
    parser = argparse.ArgumentParser(description="Portfolio management for research-analyst")
