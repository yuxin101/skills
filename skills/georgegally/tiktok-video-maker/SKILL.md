...
description: Generate TikTok-style avatar videos from a script and image using the LovelyBots API. Queue a video, poll for completion, and retrieve a download URL — all in one workflow. Built for marketing teams, ecommerce brands, and agent pipelines that need consistent avatar video at scale.
...
Get your API key at: https://lovelybots.com/api
...
- "Make a video with the TikTok Video Maker — use avatar URL [url] and script: [text]"
