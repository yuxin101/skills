...
description: "Track Facebook Page performance and analytics. Use when the user says 'Facebook analytics', 'Facebook page metrics', 'how is my Facebook doing', 'Facebook engagement', 'Facebook post performance', or wants to see reach, engagement, video views, and post metrics for their Facebook Page."
version: 1.0.0
metadata:
  openclaw:
    emoji: "📊"
...
Track your Facebook Page performance — reach, engagement, video views, and post-level metrics. Powered by [Boring](https://boring-doc.aiagent-me.com).
...
|------|-----------|----------|
| `boring_get_performance` | Real-time platform API | Page-level overview (reach, engagement, video views) |
| `boring_get_video_analytics` | Real-time platform API | Per-post metrics (views, likes, comments, shares) |
...
|-------------|------------|
| "How is my Facebook doing?" | `boring_get_performance` |
| "Show my best Facebook posts" | `boring_get_video_analytics` |
| "Facebook performance over the last month" | `boring_get_posts_performance` |
| "What did I post on Facebook?" | `boring_get_publish_history` |
