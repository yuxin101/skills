...
>
> **参考文件**：`reference/内置/ASR语义纠错.md`
>
> **前置要求**：在 `./scripts` 目录下如需运行合并脚本，使用 `uv run ./merge_asr_words.py`
...
- [ ] **输出**：
  ...
  - 若输出缺 `words`，可运行 `uv run ./merge_asr_words.py [--output-dir output/<文件名>]` 从 raw 合并
...
flowchart TD
    ...
    Words -->|否| Merge[可选 uv run merge_asr_words.py]
    Merge --> Check
