...
**Before cloning or running the installer:** From the **workspace root**, check whether **`skills/claw-wallet/install.sh`** already exists (same path as in **Installation path** below).
