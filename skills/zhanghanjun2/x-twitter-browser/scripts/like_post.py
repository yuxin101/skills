...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Like or Unlike an X tweet")
...
def open_tweet_and_like(page, tweet_url: str, tweet_id: str, undo: bool, timeout_ms: int) -> None:
