...
name: clawrecipes  
version: 0.4.23
description: "OpenClaw plugin for markdown-based agent and team scaffolding. Create sophisticated multi-agent teams with simple markdown recipes."
homepage: https://github.com/JIGGAI/ClawRecipes
metadata:
  openclaw:
    emoji: "🍽️"
    requires:
      bins: ["node"]
    tags: ["recipes", "agents", "teams", "scaffolding", "markdown", "workflows", "automation"]
---
