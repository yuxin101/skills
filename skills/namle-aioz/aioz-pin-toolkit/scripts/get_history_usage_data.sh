...
# Usage: ./get_history_usage_data.sh PINNING_API_KEY PINNING_SECRET_KEY [OFFSET] [LIMIT]
...
REQUEST_URL="https://api.aiozpin.network/api/billing/historyUsage/?$QUERY_STRING"

# Print request URL before calling API
echo "Request URL: $REQUEST_URL"

# Send request to get history usage data
