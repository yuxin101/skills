...
# Usage: ./get_pin_details.sh PIN_ID PINNING_API_KEY PINNING_SECRET_KEY
...
REQUEST_URL="https://api.aiozpin.network/api/pinning/$PIN_ID"

# Print request URL before calling API
echo "Request URL: $REQUEST_URL"

# Send request to get pin details
