...
"""
公司公告信息自然语言取数脚本
通过问句语义化搜索A股、基金、港美股相关公告信息

用法:
    python fetch_data.py "同花顺公告"
"""
...
def fetch_data(query: str, start_date: str = None, end_date: str = None) -> dict:
    ...
    url = f"{base_url}/research_pilot_service/openapi/skills/open/search/announcement?{query_string}"
