...
def main() -> int:
    parser = argparse.ArgumentParser(description="Export anonymized rides CSV from SQLite")
    parser.add_argument("--db", required=True, help="Path to rides SQLite database")
