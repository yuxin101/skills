import { yesterday } from "@bondli-skills/shared/date";
...
export async function requestAPI(page, api, payload, needModify) {
    if (needModify) {
        payload.filters[0].filterValue.startTime = yesterday("start");
        payload.filters[0].filterValue.endTime = yesterday("end");
        payload.filters[1].filterValue.startTime = yesterday("start");
        payload.filters[1].filterValue.endTime = yesterday("end");
