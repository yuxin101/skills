# founderclaw — AI Engineering Workflow

founderclaw is a collection of SKILL.md files that give AI agents structured roles for
...
| `/founderclaw-upgrade` | Update founderclaw to the latest version. |
