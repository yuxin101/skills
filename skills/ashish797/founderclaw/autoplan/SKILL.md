...
- Discover design docs: `ls -t founderclaw/data/projects/$SLUG/*-design-*.md 2>/dev/null | head -1`
...
- `founderclawplan-ceo-review/SKILL.md`
- `founderclawplan-design-review/SKILL.md` (only if UI scope detected)
- `founderclawplan-eng-review/SKILL.md`
